...
def word_tfidf_score(word, sentence, sentences):
...
def index():
    if request.method == 'POST':
        ...
        result = nlp(summary)
        summarized_sentences = [sent.text.capitalize() for sent in result.sents]
        return render_template('index.html', summarized_sentences=summarized_sentences)
